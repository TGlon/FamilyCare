<template>
  <div class="border-box d-flex flex-column ml-2">
    ...
    <div class="d-flex justify-content-between mx-3 mb-3">
      <div class="d-flex justify-content-start">
        ...
        <Search
          ...
          :placeholder="`Tìm kiếm người dùng và loại cuộc hẹn`"
        />
      </div>
    ...
    <Table
      ...
      :labels="['name', 'appointment_type', 'start_date', 'place', 'status', 'note']"
...
export default {
  ...
  return data.items.map((value, index) => {
    const appointmentType = value.appointment_type || "";
    const userName = value.User ? value.User.name : "";
    return [appointmentType, userName].join("").toLocaleLowerCase();
  });
});
